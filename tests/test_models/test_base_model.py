...
class TestBase(unittest.TestCase):
    ...
    def test_BaseModel_ids_differ(self):
        '''
    ...
    def test_BaseModel_a_updated_created_equal(self):
        '''
    ...
    def test_BaseModel_str_overide(self):
        '''
    ...
    def test_BaseModel_to_dict_type_updated_at(self):
        '''
    ...
    def test_BaseModel_to_dict_type_created_at(self):
        '''
    ...
    def test_BaseModel_type_created_at(self):
        '''
    ...
    def test_BaseModel_type_updated_at(self):
        '''
    ...
    def test_BaseModel_compare_dict(self):
        '''
    ...
    def test_BaseModel_instance_diff(self):
        '''
    ...
    def test_BaseModel_to_dict_sa_instance_filtered(self):
        '''
            Test if sa_instance key is filtered out of to_dict return
        '''
        tmp = self.my_model.to_dict()
        self.assertEqual(tmp.get('_sa_instance_state', None), None)
