...
class TestUser(unittest.TestCase):
    ...
    def test_Place_type_longitude(self):
        '''
    ...
    def test_Place_type_latitude(self):
        '''
    ...
    def test_Place_type_amenity(self):
        '''
            Test the type of latitude
        '''
    ...
    def test_Place_type_price_by_night(self):
        '''
    ...
    def test_Place_type_max_guest(self):
        '''
    ...
    def test_Place_type_number_bathrooms(self):
        '''
    ...
    def test_Place_type_number_rooms(self):
        '''
            Test the type of number_bathrooms
        '''
    ...
    def test_Place_type_description(self):
        '''
    ...
    def test_Place_type_user_id(self):
        '''
    ...
    def test_Place_type_city_id(self):
        '''
